   ...
   //  // match all() , includes(), startwith(), endswith() does not support in internet
   //  console.log(intro[0]);
...
//     console.log(intro.toUpperCase());
   ...
   //  console.log(text.padEnd(4,"b"));//To pad a number, convert the number to a string first.
   ...
   // you can change the value of pi or not? you can not change or override pi value because writable:false
   const descripter = Object.getOwnPropertyDescriptor(Math, "PI")
   console.log(descripter);

   //make your code where no one can change your name
   const user ={
      name:"mita",
      id:"123",
   ...
   console.log(Object.getOwnPropertyDescriptor(user ,"name"));
   for (let [key , value] of Object.entries(user)) { //for error in function
...
//     console.log(flatarr.flat(Infinity));
   ...
   //  console.log(Array.from("hitesh"));// you can convert funvtion(string) into single character array

   //  let s1=100;
   //  let s2=200;
   //  let s3=300;
   //  console.log(Array.of(s1,s2,s3));// better then concat or join
...
//  const x=[1,2,3,4]
//  const total = x.reduce( (acc , curr) => acc+curr, 0 )//Calls the specified callback function for all the elements in an array. 
